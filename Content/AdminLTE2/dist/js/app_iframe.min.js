var App = function () {
    var a, b = !1,
        ...
        n = function () {
            var a = ($(window).height(), $(".main-footer")),
                b = $(".main-header"),
                c = $(".content-tabs"),
                d = App.getViewPort().height - a.outerHeight() - b.outerHeight();
            c.is(":visible") && (d -= c.outerHeight()), $(".tab_iframe").css({
                height: d,
                width: "100%"
            })
        },
        ...
        s = function () {
            $("body").on("click", ".portlet > .portlet-title > .tools > a.remove", function (a) {
                ...
                a.preventDefault();
                var b = $(this).closest(".portlet");
                if (b.hasClass("portlet-fullscreen")) $(this).removeClass("on"), b.removeClass("portlet-fullscreen"), $("body").removeClass("page-portlet-fullscreen"), b.children(".portlet-body").css("height", "auto");
                else {
        ...
        u = function () {
            if ($("body").on("click", ".md-checkbox > label, .md-radio > label", function () {
                var a = $(this),
                    b = $(this).children("span:first-child");
                b.addClass("inc");
                var c = b.clone(!0);
    ...
    return {
        ...
        scrollTo: function (a, b) {
            ...
            a && ($("body").hasClass("page-header-fixed") ? c -= $(".page-header").height() : $("body").hasClass("page-header-top-fixed") ? c -= $(".page-header-top").height() : $("body").hasClass("page-header-menu-fixed") && (c -= $(".page-header-menu").height()), c += b ? b : -1 * a.height()), $("html,body").animate({
                scrollTop: c
            }, "slow")
        },
...
var addTabs = function (a) {
    ...
    refreshTab = function () {
        var a = $(".page-tabs-content").find(".active").attr("data-id"),
            b = $("#iframe_" + a),
            c = b.attr("src");
        b.attr("src", c)
    },
    ...
    scrollTabRight = function () {
        var a = Math.abs(parseInt($(".page-tabs-content").css("margin-left"))),
            b = calSumWidth($(".content-tabs").children().not(".menuTabs")),
            c = $(".content-tabs").outerWidth(!0) - b,
            d = 0;
        ...
        d = calSumWidth($(e).prevAll()), d > 0 && $(".page-tabs-content").animate({
            marginLeft: 0 - d + "px"
        }, "fast")
    },
    scrollToTab = function (a) {
        var b = calSumWidth($(a).prevAll()),
            c = calSumWidth($(a).nextAll()),
            d = calSumWidth($(".content-tabs").children().not(".menuTabs")),
            e = $(".content-tabs").outerWidth(!0) - d,
            f = 0;
        if ($(".page-tabs-content").outerWidth() < e) f = 0;
        else if (c <= e - $(a).outerWidth(!0) - $(a).next().outerWidth(!0)) {
            ...
            function c(b, d, e) {
                a.each(d, function (d, f) {
                    ...
                    if (l === !0 && i.addClass("active"), f.children && f.children.length > 0) {
                        ...
                        if (null != f.targetType && "blank" === f.targetType) h.attr("href", f.url), h.attr("target", "_blank");
                        else if (null != f.targetType && "ajax" === f.targetType) h.attr("href", f.url), h.addClass("ajaxify");
                        else if (null != f.targetType && "iframe-tab" === f.targetType) {
