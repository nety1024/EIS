...
var App = function () {
    ...
    var requestFullScreen = function () {
        ...
        if (de.requestFullscreen) {
            ...
            App.alert({ message: "이 브라우저는 전체 화면을 지원하지 않습니다!", type: "danger"});
        }
...
var addTabs = function (options) {
    ...
    if (findTabPanel(pageId) === null) {
        ...
        //是否允许关闭
        if (options.close) {
            var $i = $("<i class='fa fa-remove page_tab_close' style='cursor: pointer; padding-left: 7px;' onclick='closeTab(this);'></i>").attr(pageIdField, pageId).appendTo($title);
